...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Prodysor Terminal"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.prodysor.term"; // Default: "com.termux"
    /** Java namespace retained from upstream; distinct from the Android application ID. */
    public static final String TERMUX_APP_JAVA_PACKAGE_NAME = "com.termux";
    ...
    public static final class TERMUX_APP {
        ...
        public static final String BUILD_CONFIG_CLASS_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".BuildConfig"; // Default: "com.termux.BuildConfig"

        /** Termux app FileShareReceiverActivity class name */
        public static final String FILE_SHARE_RECEIVER_ACTIVITY_CLASS_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.api.file.FileShareReceiverActivity"; // Default: "com.termux.app.api.file.FileShareReceiverActivity"

        /** Termux app FileViewReceiverActivity class name */
        public static final String FILE_VIEW_RECEIVER_ACTIVITY_CLASS_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.api.file.FileViewReceiverActivity"; // Default: "com.termux.app.api.file.FileViewReceiverActivity"


        /** Termux app core activity name. */
        public static final String TERMUX_ACTIVITY_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.TermuxActivity"; // Default: "com.termux.app.TermuxActivity"
        ...
        public static final String TERMUX_SETTINGS_ACTIVITY_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.activities.SettingsActivity"; // Default: "com.termux.app.activities.SettingsActivity"
        ...
        public static final String TERMUX_SERVICE_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.TermuxService"; // Default: "com.termux.app.TermuxService"
        ...
        public static final String RUN_COMMAND_SERVICE_NAME = TERMUX_APP_JAVA_PACKAGE_NAME + ".app.RunCommandService"; // Termux app service to receive commands from 3rd party apps "com.termux.app.RunCommandService"
